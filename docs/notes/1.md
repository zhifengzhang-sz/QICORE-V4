...
- Language-specific guides that depend on package research:
  - `impl.ts.prompt.md` → uses `package/ts.md` 
  - `impl.py.prompt.md` → uses `package/py.md`
...
Create `sources/guides/mathematical-contracts.md` containing ONLY:
...
`build/objective/formal.spec.md` (Mathematical Definitions)
    ↓ (sources/guides/design.prompt.md + sources/guides/common.md + sources/guides/mathematical-contracts.md + build/objective/formal.spec.md)
...
2. sources/guides/design.prompt.md + sources/guides/common.md + sources/guides/mathematical-contracts.md + build/objective/formal.spec.md → build/design/*.md
...
Create `sources/guides/mathematical-contracts.md` with:
...
- `sources/guides/mathematical-contracts.md` (abstract interface contracts)
