...
// Factory function to create and configure the code generator
export function createCodeGenerator(_config: CodeGeneratorConfig): AICodeGenerator {
  const generator = new AICodeGenerator();

  // The AICodeGenerator uses the config internally via the options parameter
  // The factory just creates a consistent interface for the orchestrator
  return generator;
}
