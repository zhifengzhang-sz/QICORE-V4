...
export namespace QiError {
   ...
   */
  export function validationError(message: string, field: string, value: unknown): QiError {
    return {
   ...
   */
  export function networkError(message: string, url: string, statusCode?: number): QiError {
    return {
   ...
   */
  export function configurationError(message: string, key: string, expectedType: string): QiError {
    return {
   ...
   */
  export function integrationError(message: string, service: string, operation: string): QiError {
    return {
